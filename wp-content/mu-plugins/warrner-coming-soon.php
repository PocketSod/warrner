...
<head>
	...
	<title><?php esc_html_e( 'Coming Soon | Warrner Legal', 'warrner' ); ?></title>
...
<body>
	<main class="cs-card">
		...
		<p class="cs-lede"><?php esc_html_e( "We're putting the finishing touches on erinwlegal.com. Until then, call or email us directly.", 'warrner' ); ?></p>
		...
		<p class="cs-credit"><?php esc_html_e( 'Website by', 'warrner' ); ?> <a href="https://pocketsod.com" target="_blank" rel="noopener">PocketSod</a></p>
	</main>
</body>
</html>
	<?php
