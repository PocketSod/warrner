export default function FrontlineFooter() {
  return (
    <footer className="border-t-4 border-fl-red-dark bg-fl-ink text-fl-bg">
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <p className="font-fl-heading text-lg font-black uppercase tracking-tight">Warrner</p>
            <p className="mt-1 font-fl-label text-xs uppercase tracking-[0.2em] text-white/50">
              Immigration Law
            </p>
            <p className="mt-4 max-w-xs font-fl-body text-sm leading-relaxed text-white/60">
          ...
          <div>
            <p className="font-fl-label text-xs font-bold uppercase tracking-[0.2em] text-fl-red-light">Practices</p>
            <ul className="mt-4 flex flex-col gap-2.5 font-fl-body text-sm text-white/70">
          ...
          <div>
            <p className="font-fl-label text-xs font-bold uppercase tracking-[0.2em] text-white/50">Firm</p>
            <ul className="mt-4 flex flex-col gap-2.5 font-fl-body text-sm text-white/70">
          ...
          <div>
            <p className="font-fl-label text-xs font-bold uppercase tracking-[0.2em] text-white/50">Contact</p>
            <ul className="mt-4 flex flex-col gap-2.5 font-fl-body text-sm text-white/70">
        ...
        <div className="mt-16 flex flex-col gap-2 border-t border-white/15 pt-6 font-fl-body text-xs text-white/40 sm:flex-row sm:items-center sm:justify-between">
